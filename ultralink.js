/* ultralinks.js by Christopher Gutteridge 2018
   https://github.com/cgutteridge/ultralink/
   GPLv3 

   This is a first attempt at a library that allows deep linking to a range of text inside a page. 
   It stores the link information in the URL fragment, and on page load it detects the fragment and 
   injects markup into the page to highlight the section, and scrolls to it.
   The start/end points are represented by the "ID" of the <article> or worldpress <div class='post'>
   that they are within, and a character offset within the article. This should be safer when the page 
   template alters. Other encodings may be better, eg. DOM path plus offset within HTML DOM element.

   This code is part of the JRNL project.
*/
